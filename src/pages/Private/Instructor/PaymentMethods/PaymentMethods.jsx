      ...
      <PageTransition>
        ...
        <div className="main">
          ...
          <div className="method">
            ...
            <button className="small-button" onClick={() => getLink("stripe")} disabled={loadingStripe}>
              {loadingStripe ? (
                <>
                  <SpinnerOfDoom />
                  Cargando...
          ...
          <div className="method">
            ...
            <button className="small-button" onClick={() => getLink("paypal")} disabled={loadingPaypal}>
              {loadingPaypal ? (
                <>
                  <SpinnerOfDoom />
                  Cargando...
